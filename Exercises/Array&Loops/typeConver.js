...
// Your friend Kojo is a big fan of numbers.He has a small website for playing around with numbers:
//     www.fun -with-numbers.com.Kojo is not that good at programming so he asked you for help.
...
// Another game on the website is a little quiz called "Lucky Numbers".A user can enter a number and then sees whether
// the number belongs to some secret sequence or pattern.The sequence or pattern of the "lucky numbers" changes
// each month and each user only has a limited number of tries to guess it.
...
// The function should return true if the number is a palindrome and false otherwise.The input number will always be a positive integer.
...
// Kojo wants to improve the user experience of his site.He wants to show an error message in case the 
