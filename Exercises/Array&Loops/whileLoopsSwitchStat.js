...
// You are a frequent customer in her shop and realized you could make your friend's life easier. You decide to use your coding skills to help Li Mei with her job.
...
// 'Pure Strawberry Joy' takes 0.5 minutes, 'Energizer' and 'Green Garden' take 1.5 minutes each, 'Tropical Island' takes 3 minutes and
...
// Implement the function limesToCut which takes the number of lime wedges Li Mei needs to cut and an array
//     representing the supply of whole limes she has at hand.She can get 6 wedges from a 'small' lime,
//     8 wedges from a 'medium' lime and 10 from a 'large' lime.
...
//     are not prepared yet when Li Mei's shift ends. Dmitry will then prepare the remaining juices.
// To make the hand - over easier, implement a function remainingOrders which takes the number of minutes
//     left in Li Mei's shift and an array of juices that have been ordered but not prepared yet.
