...
let result = needsLicense("car");
console.log(result);

// 2. Choose between two potential vehicles to buy
// You evaluate your options of available vehicles. You manage to narrow it down to two options but you need help
...
let result2 = chooseVehicle('Volkswagen ', 'Volkswagen Golf');
let result3 = chooseVehicle('Wuling Hongguang', 'Toyota Corolla');
console.log(result2);
console.log(result3);

// 3. Calculate an estimation for the price of a used vehicle
// Now that you made your decision you want to make sure you get a fair price at the dealership.Since you are
// interested in buying a used vehicle, the price depends on how old the vehicle is.For a rough estimate, assume if
// the vehicle is less than 3 years old, it costs 80 % of the original price it had when it was brand new.If it is more
// than 10 years old, it costs 50 %.If the vehicle is at least 3 years old but not older than 10 years, it costs 70 % of
// the original price.
