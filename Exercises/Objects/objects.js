...
// The keys of this object will be the names of the players, the values will be their scores. For testing purposes, you want to directly include one entry in the object. 
...
// The function adds the bonus points for each player that is listed on that board. Afterwards, the board is returned.
...
// Write a function normalizeScore. To practice your object skills, instead of two parameters 
// this function should accept one object as a parameter. That object contains a key score with 
// the value being a player's score (a number). There is also a second key normalizeFunction that has a function as its value. 
