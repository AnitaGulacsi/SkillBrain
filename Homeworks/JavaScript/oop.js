...
// Pe lângă constructor, definește o metodă de tip getter 
...
// La final, definește separat o funcție numită main, in care se vor crea 3 instanțe ale clasei mașina folosind operatorul 
//new. Fiecare instanță va fi memorata Într-o variabilă separată și va avea proprietăți diferite. 
...
//Metoda va verifica daca pozitiaInCampionat este un numar mai mare ca 0, iar in cazul in care numarul este mai mic 
//sau egal cu 0, se va afisa mesajul “Nu am castigat niciun premiu”.
...
class MasinaDeCurse extends masina {
    constructor(marca, model, culoare, kilometraj) {
        // Apelul constructorului clasei părinte folosind super
...
function main2() {
    const masinaCuPremiu = new MasinaDeCurse("Toyota", "Turbo", "Rosu", 100000);
    masinaCuPremiu.participaLaCampionat(2);
    console.log(masinaCuPremiu.proprietati);

    const masinaFaraPremiu = new MasinaDeCurse("Ford", "Speedster", "Alb", 75000);
    masinaFaraPremiu.participaLaCampionat(0);
    console.log(masinaFaraPremiu.proprietati);
}
